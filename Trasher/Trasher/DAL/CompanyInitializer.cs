...
namespace Trasher.DAL
{
    public class CompanyInitializer : DropCreateDatabaseAlways<CompanyContext>
    {
        protected override void Seed(CompanyContext context)
        {
            ...
            {
                new PickupDay{dayName="Monday"},
                new PickupDay{dayName="Tuesday"},
                new PickupDay{dayName="Wednesday"},
                new PickupDay{dayName="Thursday"},
                new PickupDay{dayName="Friday"},
                new PickupDay{dayName="Saturday" }
        };

            pickupDays.ForEach(p => context.PickupDays.Add(p));
            context.SaveChanges();
